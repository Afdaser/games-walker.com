...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.com.ua/" rel="nofollow"><img src="https://assets.hostinger.com/content/hostinger_welcome/images/hostinger-logo.png" width="120" alt="Hostinger"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.com.ua/rukovodstva/" rel="nofollow"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Руководства</a>
                </li>
                <li>
                    <a href="https://www.hostinger.com.ua/make-money-online/" rel="nofollow"><i aria-hidden="true" class="fa fa-trophy"></i> Зарабатывайте с нами</a>
                </li>
                <li>
                    <a href="https://www.hostinger.com.ua/partnerstvo" rel="nofollow"><i aria-hidden="true" class="fa fa-user"></i> Партнёры</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.com.ua" rel="nofollow"><i aria-hidden="true" class="fa fa-lock"></i> Вход</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Ваш аккаунт был создан!</h1><em></em>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com.ua/zarabativaite-online" rel="nofollow">Узнать больше</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com.ua/baza-znaniy" rel="nofollow">Узнать больше</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com/blog/" rel="nofollow">Узнать больше</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://cpanel.hostinger.com.ua" rel="nofollow">Вход для Клиентов</a>
                </div>
                <div class="copyright text-center">
                    Hostinger © <?php echo date("Y"); ?>. Все права защищены
                </div>
            </div>
        </div>
    </div>
