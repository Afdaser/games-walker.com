...
document.addEventListener('DOMContentLoaded', function () {
  ...
  spoilers.forEach(function (details, index) {
    ...
    if (body) {
      body.insertAdjacentHTML('afterbegin', '<div class="spoiler-ad-block"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2328584419845560" crossorigin="anonymous"></script>@-- spoiler --<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2328584419845560" data-ad-slot="5510401721" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script></div>');
    }
  });
