...
- source: [doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.jpg
- destination: [doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.webp
...
cwebp -metadata none -q 80 -alpha_q '85' -m 6 -low_memory '[doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.jpg' -o '[doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.webp.lossy.webp' 2>&1 2>&1
Exec failed (return code: 254)
Creating command line options for version: 0.3.0
*The near-lossless option is not supported on this (rather old) version of cwebp- skipping it.* 
Trying to convert by executing the following command:
/bin/cwebp -metadata none -q 80 -alpha_q '85' -m 6 -low_memory '[doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.jpg' -o '[doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.webp.lossy.webp' 2>&1 2>&1

*Output:* 
Saving file '[doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.webp.lossy.webp'
File:      [doc-root]/wp-content/uploads/2020/09/Free-Fire-na-PK-300x98.jpg
Dimension: 300 x 98
Output:    5352 bytes Y-U-V-All-PSNR 40.23 42.37 41.54   40.73 dB
block count:  intra4: 99
              intra16: 34  (-> 25.56%)
              skipped block: 25 (18.80%)
bytes used:  header:             93  (1.7%)
             mode-partition:    593  (11.1%)
 Residuals bytes  |segment 1|segment 2|segment 3|segment 4|  total
  intra4-coeffs:  |     642 |    1575 |    1216 |     121 |    3554  (66.4%)
 intra16-coeffs:  |       0 |       0 |      17 |      42 |      59  (1.1%)
  chroma coeffs:  |      96 |     466 |     408 |      56 |    1026  (19.2%)
    macroblocks:  |       6%|      24%|      35%|      33%|     133
      quantizer:  |      27 |      24 |      19 |      14 |
   filter level:  |      12 |       8 |       5 |       3 |
------------------+---------+---------+---------+---------+-----------------
 segments total:  |     738 |    2041 |    1641 |     219 |    4639  (86.7%)

Success
Reduction: 35% (went from 8176 bytes to 5352 bytes)
...
Reduction: 36% (went from 8176 bytes to 5238 bytes)

Converting to lossless
Reduction: -318% (went from 8176 bytes to 34204 bytes)

Picking lossy
imagick succeeded :)

Converted image in 54646 ms, reducing file size with 36% (went from 8176 bytes to 5238 bytes)
